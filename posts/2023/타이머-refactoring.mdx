...
<Image
  alt="countdown timer 상태변화"
  src="/images/posts/2023/타이머-refactoring/countdown-timer-상태변화.png"
  width={720}
  height={480}
/>

```ts title="countdown-timer.ts" showLineNumbers
...
```tsx title="selected-to-do-progress-timer.tsx" showLineNumbers
